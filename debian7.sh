...
echo 'echo -e "Script by NamiaKai-"' >> .bashrc
echo 'echo -e "Taip menu untuk menampilkan daftar perintah"' >> .bashrc
echo 'echo -e ""' >> .bashrc
...
echo ""  | tee -a log-install.txt
echo "Original Script by NamiaKai-"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
